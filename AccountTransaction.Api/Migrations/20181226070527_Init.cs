        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(maxLength: 33, nullable: false),
                    MiddleName = table.Column<string>(maxLength: 33, nullable: true),
                    LastName = table.Column<string>(maxLength: 33, nullable: false),
                    Email = table.Column<string>(maxLength: 50, nullable: false),
                    CellNo = table.Column<string>(maxLength: 15, nullable: false),
